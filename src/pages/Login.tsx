...
export default function Login() {
  ...
  const [activePreset, setActivePreset] = useState(0); // 0 = Admin selected
  ...
  return (
    <div style={{
      ...
      <div style={{
        position: "absolute", inset: 0,
        background: "linear-gradient(120deg, rgba(5,20,55,0.52) 0%, rgba(10,60,30,0.38) 100%)",
        zIndex: 1,
      }} />
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img
            ...
            style={{
              width: "min(430px, 38vw)", height: "auto",
              filter: "drop-shadow(0 8px 36px rgba(0,0,0,0.6))",
              userSelect: "none",
            }}
          />
          <p style={{
            marginTop: "16px", fontSize: "clamp(13px,1.2vw,17px)",
            color: "rgba(255,255,255,0.85)", fontWeight: 400,
            letterSpacing: "0.5px", textShadow: "0 2px 8px rgba(0,0,0,0.5)",
            textAlign: "center",
          }}>
            Khinwara, Rajasthan — 306502
          </p>
          <p style={{
            fontSize: "clamp(11px,1vw,14px)", color: "rgba(255,255,255,0.60)",
            marginTop: "4px", textShadow: "0 2px 6px rgba(0,0,0,0.4)", textAlign: "center",
          }}>
        ...
        <div style={{
          ...
          borderRadius: "22px",
          overflow: "hidden",
          boxShadow: "0 28px 80px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,255,255,0.12)",
        }}>

          {/* Card Header — colourful gradient */}
          <div style={{
            background: "linear-gradient(135deg, #0d2351 0%, #1e57b0 50%, #0e7c4a 100%)",
            ...
            <p style={{
              fontSize: "12px", color: "rgba(255,255,255,0.80)",
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{ fontSize: "11px", color: "#b0bcc8", whiteSpace: "nowrap" }}>
                ya manually bharein
              </span>
              <div style={{ flex: 1, height: "1px", background: "#e8edf3" }} />
            </div>
            ...
            <form onSubmit={handleLogin} style={{
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
                <label style={{ fontSize: "12px", fontWeight: 600, color: "#2a3a5a" }}>
                  Username
                </label>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input
                    ...
                    style={{
                      width: "100%", height: "44px",
                      paddingLeft: "36px", paddingRight: "42px",
                      border: "1.5px solid #d5dde8", borderRadius: "10px",
                      fontSize: "14px", color: "#1a2a4a",
                      outline: "none", background: "#f8fafc",
                      boxSizing: "border-box",
                  ...
                  <button
                    ...
                    style={{
                      ...
                      cursor: "pointer", color: "#8a9ab0", padding: 0,
                    }}
                  >
                    {showPassword
              ...
              <button
                ...
                style={{
                  ...
                  marginTop: "4px",
                  boxShadow: loading ? "none" : "0 6px 20px rgba(30,87,176,0.40)",
                  letterSpacing: "0.5px",
                  display: "flex", alignItems: "center",
            ...
            <div style={{
              marginTop: "18px",
              display: "flex", alignItems: "center", justifyContent: "center",
              gap: "5px", color: "#8a9ab0", fontSize: "11px",
            }}>
